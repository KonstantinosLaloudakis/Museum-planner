...
<div class="container-fluid h-100 ">
  ...
  <div class="col-sm-2  hidden-md-down">
	<div class="btn-group-vertical">
		...
		<li> <button class="btn btn-light" id="small" onclick="createImage(this.id)"> Small</button></li></li>
        <li> <button class="btn btn-light" id="medium" onclick="createImage(this.id)"> Medium</button></li></li>
		<li> <button class="btn btn-light" id="large" onclick="createImage(this.id)"> Large</button></li></li>
		</ul>
	</div>
